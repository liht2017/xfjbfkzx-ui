...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            permissionList() {
                return {
                    addBtn: this.vaildData(this.permissions.mall_freighttemplat_add, false),
                    delBtn: this.vaildData(this.permissions.mall_freighttemplat_del, false),
                    editBtn: this.vaildData(this.permissions.mall_freighttemplat_edit, false),
                    viewBtn: this.vaildData(this.permissions.mall_freighttemplat_get, false)
                };
            }
        },
        methods: {
