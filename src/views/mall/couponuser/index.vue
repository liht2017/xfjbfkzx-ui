...
<script>
    import {getPage, getObj, addObj, putObj, delObj} from '@/api/mall/couponuser'
    import {tableOption} from '@/const/crud/mall/couponuser'
    ...
    export default {
        ...
        computed: {
            ...
            permissionList() {
                return {
                    addBtn: this.vaildData(this.permissions.mall_couponuser_add, false),
                    delBtn: this.vaildData(this.permissions.mall_couponuser_del, false),
                    editBtn: this.vaildData(this.permissions.mall_couponuser_edit, false),
                    viewBtn: this.vaildData(this.permissions.mall_couponuser_get, false)
                };
            }
        },
        methods: {
